...
import './DiagnosticCodeSearch.css'; // Reuse the same styles

const BillingCodeSearch = ({ onAddCode, availableCodes }) => {
    ...
    <div className="diagnostic-code-search" ref={dropdownRef}>
      <div className="search-input-container">
        <input
          ...
          placeholder="Search billing codes (CPT)..."
          value={searchTerm}
      ...
      {showDropdown && filteredCodes.length === 0 && searchTerm.length > 0 && (
        <div className="diagnostic-dropdown">
          <div className="dropdown-empty">
            ...
            <div className="empty-text">No billing codes found</div>
...
export default BillingCodeSearch;
